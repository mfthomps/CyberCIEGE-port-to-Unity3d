...
//Name: boxwithwires.ma
//Last modified: Thu, Jan 08, 2004 04:02:30 PM
requires maya "4.5";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.82023877072011242 1.2898307992549451 2.9078705569970738 ;
	setAttr ".r" -type "double3" -28.547365907329354 -14.199999999984346 -4.1009979079884753e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 4.249110504141699;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".rnd" no;
	setAttr ".coi" 100;
	setAttr ".ow" 9.3358633776091082;
	setAttr ".imn" -type "string" "side";
	setAttr ".den" -type "string" "side_depth";
	setAttr ".man" -type "string" "side_mask";
	setAttr ".hc" -type "string" "viewSet -s %camera";
	setAttr ".o" yes;
createNode transform -n "boxwithwires";
createNode mesh -n "boxwithwiresShape" -p "boxwithwires";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr -s 20 ".uvst[0].uvsp[0:19]" -type "float2" 0.99800783 
		0.99800801 0.99800789 0.25624394 0.99800789 0.99800801 0.99800777 0.256244 
		0.75531185 0.256244 -2.1846041e-008 2.5263279e-008 0.99999988 2.5263279e-008 
		0.99999988 0.2493962 -2.1846041e-008 0.2493962 0.99800783 0.256244 0.99800783 
		0.99800801 0.75531185 0.99800801 0.75531185 0.256244 0.75531185 0.99800801 
		0.75531191 0.25624394 0.75531191 0.99800801 0.0019920319 0.25881487 0.74732053 
		0.25881487 0.74732053 0.99800795 0.0019920319 0.99800795;
	setAttr ".cuvs" -type "string" "map1";
	setAttr -s 8 ".vt[0:7]"  -0.5 0.011381484 0.5 0.5 0.011381484 
		0.5 -0.5 0.26812935 0.5 0.5 0.26812935 0.5 -0.5 0.26812935 -0.5 0.5 0.26812935 
		-0.5 -0.5 0.011381484 -0.5 0.5 0.011381484 -0.5;
...
createNode phong -n "boxwithwires_mat";
...
createNode file -n "file1";
	setAttr ".ftn" -type "string" (
		"C:/art/NPS/3d/objects/boxwithwires//textures/boxwithwires.tga");
...
connectAttr "file1.oc" "boxwithwires_mat.c";
connectAttr "boxwithwires_mat.oc" "phong1SG.ss";
connectAttr "boxwithwiresShape.iog" "phong1SG.dsm" -na;
...
connectAttr "boxwithwires_mat.msg" ":defaultShaderList1.s" -na;
connectAttr "place2dTexture1.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "place2dTexture2.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "lightLinker1.msg" ":lightList1.ln" -na;
connectAttr "file1.msg" ":defaultTextureList1.tx" -na;
// End of boxwithwires.ma
