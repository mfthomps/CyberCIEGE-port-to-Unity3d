...
//Name: swetebait.ma
//Last modified: Mon, Jan 12, 2004 03:16:51 PM
requires maya "4.5";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.2022377844350203 1.4709905088114126 3.5305020004611039 ;
	setAttr ".r" -type "double3" -20.747365907356929 -710.99999999995941 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 5.2353741918940058;
...
createNode transform -s -n "front";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.020346715198179873 -1.1495894086971306 100 ;
createNode camera -s -n "frontShape" -p "front";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100;
	setAttr ".ow" 10.72271890944049;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".rnd" no;
	setAttr ".coi" 100;
	setAttr ".ow" 8.1404174573055013;
	setAttr ".imn" -type "string" "side";
	setAttr ".den" -type "string" "side_depth";
	setAttr ".man" -type "string" "side_mask";
	setAttr ".hc" -type "string" "viewSet -s %camera";
	setAttr ".o" yes;
createNode transform -n "swetebait";
createNode mesh -n "swetebaitShape" -p "swetebait";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr -s 20 ".uvst[0].uvsp[0:19]" -type "float2" 0.73488533 
		0.99098188 0.98960382 0.99098188 0.0029604137 0.25713146 0.99557745 0.25713146 
		0.73488533 0.50786626 0.98960376 0.50786626 0.0029603504 0.0039463639 0.99557757 
		0.0039469399 0.99557745 0.25819027 0.0029604137 0.25819004 0.0029603504 0.50529808 
		0.99557757 0.50529748 0.0090180645 0.50812221 0.74155772 0.50812221 0.74155772 
		0.99098194 0.0090180645 0.99098194 0.73488533 0.99098194 0.73488533 0.50786632 
		0.98960382 0.50786632 0.98960382 0.99098194;
	setAttr ".cuvs" -type "string" "map1";
	setAttr -s 8 ".pt[0:7]" -type "float3"  0 -0.001597697 0 
		0 -0.001597697 0 0 -0.086395547 0 0 -0.086395547 0 0 -0.086395547 0 0 -0.086395547 
		0 0 -0.001597697 0 0 -0.001597697 0;
	setAttr -s 8 ".vt[0:7]"  -0.5 0.0062804152 0.5 0.5 0.0062804152 
		0.5 -0.5 0.33961374 0.5 0.5 0.33961374 0.5 -0.5 0.33961374 -0.5 0.5 0.33961374 
		-0.5 -0.5 0.0062804152 -0.5 0.5 0.0062804152 -0.5;
	setAttr -s 17 ".ed[0:16]"  0 1 0 2 3 
		0 4 5 0 6 7 0 0 2 0 1 
		3 0 2 4 0 3 5 0 4 6 0 
		5 7 0 6 0 0 7 1 0 1 2 
		1 3 4 1 5 6 1 7 3 1 0 
		4 1;
...
createNode phong -n "swetebait_mat";
createNode shadingEngine -n "phong1SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
createNode file -n "file1";
	setAttr ".ftn" -type "string" "C:/art/NPS/3d/objects/swetebait//textures/swetebait.tga";
...
connectAttr "file1.oc" "swetebait_mat.c";
connectAttr "swetebait_mat.oc" "phong1SG.ss";
connectAttr "swetebaitShape.iog" "phong1SG.dsm" -na;
...
connectAttr "swetebait_mat.msg" ":defaultShaderList1.s" -na;
