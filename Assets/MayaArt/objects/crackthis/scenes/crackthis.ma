...
//Name: crackthis.ma
//Last modified: Mon, Jan 12, 2004 04:12:21 PM
requires maya "4.5";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.0310422707344067 4.5632377560977933 3.6056262972689677 ;
	setAttr ".r" -type "double3" -49.547365907325684 -754.59999999997797 1.9319731231931314e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 6.2339575735546502;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
createNode transform -n "crackthis";
createNode mesh -n "crackthisShape" -p "crackthis";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr -s 20 ".uvst[0].uvsp[0:19]" -type "float2" 0.99999994 
		0.99439901 0.99999988 0.50938088 0.0079605756 0.51272309 0.7457571 0.51272309 
		0.7457571 0.99277663 0.0079605756 0.99277663 0.99999994 0.49855655 -5.9604645e-008 
		0.49855655 0.74420476 0.50938106 0.74420369 0.99439895 0.99999988 0.50938088 
		0.99999994 0.99439895 -1.9267134e-008 -5.8450733e-009 1 -5.8450733e-009 1 
		0.24689174 -1.9267134e-008 0.24689174 -5.9604645e-008 0.25917351 0.99999994 
		0.25917351 0.74420369 0.99439883 0.74420476 0.50938094;
	setAttr ".cuvs" -type "string" "map1";
	setAttr -s 8 ".vt[0:7]"  -0.86111099 0.00023779234 0.5 0.86111099 
		0.00023779234 0.5 -0.86111099 0.35579342 0.5 0.86111099 0.35579342 0.5 -0.86111099 
		0.35579342 -0.5 0.86111099 0.35579342 -0.5 -0.86111099 0.00023779234 -0.5 
		0.86111099 0.00023779234 -0.5;
...
createNode phong -n "crackthis_mat";
createNode shadingEngine -n "phong1SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
createNode file -n "file1";
	setAttr ".ftn" -type "string" "C:/art/NPS/3d/objects/crackthis//textures/crackthis.tga";
...
connectAttr "file1.oc" "crackthis_mat.c";
connectAttr "crackthis_mat.oc" "phong1SG.ss";
connectAttr "crackthisShape.iog" "phong1SG.dsm" -na;
...
connectAttr "crackthis_mat.msg" ":defaultShaderList1.s" -na;
