...
//Name: enigma2000.ma
//Last modified: Thu, Jan 08, 2004 10:53:09 AM
requires maya "4.5";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.98934718179698389 4.7924853538998091 6.3146882278340843 ;
	setAttr ".r" -type "double3" -35.147365907352246 -371.39999999998281 4.0557077008444545e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 8.5097011255660711;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".rnd" no;
	setAttr ".coi" 100;
	setAttr ".ow" 3.8907442146840983;
	setAttr ".imn" -type "string" "side";
	setAttr ".den" -type "string" "side_depth";
	setAttr ".man" -type "string" "side_mask";
	setAttr ".hc" -type "string" "viewSet -s %camera";
	setAttr ".o" yes;
createNode transform -n "enigma2000";
createNode mesh -n "enigmaShape2000" -p "enigma2000";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr -s 20 ".uvst[0].uvsp[0:19]" -type "float2" 0.74257344 
		0.25614065 0.99370492 0.25614065 0.74257344 0.25614071 0.74257344 0.99800801 
		0.99370492 0.25614071 0.99370492 0.99800801 0.7425735 0.99800795 0.99370492 
		0.99800795 0.0036727986 0.0028241277 0.99725246 0.002824706 0.9972524 0.25723708 
		0.0036727041 0.25723612 0.0049095824 0.25863886 0.74062687 0.2586382 0.74062657 
		0.99340475 0.0049100518 0.99340403 0.74257344 0.25614065 0.74257344 0.99800795 
		0.99370492 0.99800795 0.99370492 0.25614065;
	setAttr ".cuvs" -type "string" "map1";
	setAttr -s 8 ".vt[0:7]"  -0.67777777 0.0045145904 0.5 0.67777777 
		0.0045145904 0.5 -0.67777777 0.32585776 0.5 0.67777777 0.32585776 0.5 -0.67777777 
		0.32585776 -0.5 0.67777777 0.32585776 -0.5 -0.67777777 0.0045145904 -0.5 
		0.67777777 0.0045145904 -0.5;
...
createNode phong -n "enigma_2000";
createNode shadingEngine -n "phong1SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
createNode file -n "file1";
	setAttr ".ftn" -type "string" "C:/art/NPS/3d/objects/enigma2000//textures/enigma2000.tga";
...
connectAttr "file1.oc" "enigma_2000.c";
connectAttr "enigma_2000.oc" "phong1SG.ss";
connectAttr "enigmaShape2000.iog" "phong1SG.dsm" -na;
...
connectAttr "enigma_2000.msg" ":defaultShaderList1.s" -na;
connectAttr "place2dTexture1.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "place2dTexture2.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "place2dTexture3.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "lightLinker1.msg" ":lightList1.ln" -na;
connectAttr "file1.msg" ":defaultTextureList1.tx" -na;
// End of enigma2000.ma
