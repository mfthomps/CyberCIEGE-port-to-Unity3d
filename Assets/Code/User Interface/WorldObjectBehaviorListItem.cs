...
namespace Code.User_Interface {
  //Represents one selectable WorldObjectBehavior item in the WorldObjectBehavior List UI screen
  public abstract class WorldObjectBehaviorListItem<T> : DynamicListItem<T> {
    [Header("UI Elements")]
